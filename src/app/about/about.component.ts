...
export class AboutComponent implements OnInit {
  ...
  ngOnInit() {
	...
	cards = [
		{ title : "About Me", text: 
			[ "I’m currently working as a Web Developer and Online Project Manager for Luth Research, an independent market research firm that conducts online surveys for large corporations. At Luth, I primarily work in Python, JavaScript, HTML, and CSS to code online surveys.", 
			 "In addition to my work at Luth, I also do part-time Front-End work for a local software startup in San Diego called Urban Translations.", 
		...
		{ title : 'Play', text: 
			["When I'm not working, I spend my free time surfing, gaming, listening to podcasts, cooking, and hiking with my wife Brittany and Labrador pup Indie."]},
	];
